...
//--TOSTRING	
	...
	{
	  	return $this->nombre."-".$this->direccion."-".$this->lat."-".$this->lng."-".$this->telefono."-".$this->foto1."-".$this->foto2."-".$this->foto3;
	}
//--------------------------------------------------------------------------------//
...
//--------------------------------------------------------------------------------//
	...
	{
		$objetoAccesoDato = AccesoDatos::dameUnObjetoAcceso(); 
		$consulta =$objetoAccesoDato->RetornarConsulta("INSERT into sucursales (nombre,direccion,lat,lng,telefono,foto1,foto2,foto3) values(:nombre,:direccion,:lat,:lng,:telefono,:foto1,:foto2,:foto3)");
