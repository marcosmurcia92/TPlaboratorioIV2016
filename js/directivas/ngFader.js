(function () {
    ...
    angular.module('ngFader', [])
	  ...
	  function controller($scope){
		...
		//$scope.miObjeto = '=miobjetoconfotos';
	  ...
	  return {
	    ...
	    template: '<div class="ng-fader">'+
			...
			'<ul>' + 
				'<li ng-repeat="image in images" ng-click="toggleStartStop()" ng-swipe-right="sliderBack()" ng-swipe-left="sliderForward()"><img ng-src="{{image.src}}" data-ng-alt="{{image.alt}}" ng-class="show($index)"/></li>' + 
			'</ul>' + 
